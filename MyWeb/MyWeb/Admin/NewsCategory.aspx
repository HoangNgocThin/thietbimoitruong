<%@ Page Language="C#" MasterPageFile="~/AdminMaster.Master" AutoEventWireup="true" CodeBehind="NewsCategory.aspx.cs" Inherits="MyWeb.Admin.NewsCategory" %>

<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="PageName">Nhóm sản phẩm</div>
    <asp:Panel ID="pnView" runat="server">
        ...
        <asp:DataGrid ID="grdNewsCategory" runat="server" Width="100%" CssClass="TableView" AutoGenerateColumns="False" AllowPaging="True" PageSize="10" PagerStyle-Mode="NumericPages" PagerStyle-HorizontalAlign="Center" OnItemDataBound="grdNewsCategory_ItemDataBound" OnItemCommand="grdNewsCategory_ItemCommand" OnPageIndexChanged="grdNewsCategory_PageIndexChanged">
            ...
            <Columns>
                ...
                <asp:BoundColumn DataField="Name" HeaderText="Tên nhóm tin" ItemStyle-CssClass="Text" Visible="true" />
    ...
    <asp:Panel ID="pnUpdate" runat="server" Visible="False">
        <table class="TableUpdate" border="1">
            ...
            <tr>
                <th>
                    <asp:Label ID="lblName" runat="server" Text="Tên nhóm tin:"></asp:Label></th>
                <td>
