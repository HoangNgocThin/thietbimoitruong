<%@ Page Title="" Language="C#" MasterPageFile="~/DefaultMaster.Master" AutoEventWireup="true" CodeBehind="ProductView.aspx.cs" Inherits="MyWeb.Modules.Products.ProductView" %>
...
<div class='dv_sp'>
    <asp:DataList CssClass="dtlspsanpham" ID="dtlproductbycateloge" runat="server" RepeatColumns="3" >
        <ItemTemplate>
            <table>
                <tr>
